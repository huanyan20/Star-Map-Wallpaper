...
class LabelLayer {
  constructor(font, texture) {
    ...
    this.lineHeight =
      font.common && font.common.lineHeight ? font.common.lineHeight : this.scaleBase;
  ...
  update(labels) {
    ...
    for (let idx = 0; idx < labels.length; idx++) {
      ...
      for (let i = 0; i < text.length;) {
        ...
        this.positions[pIdx++] = wx0;
        this.positions[pIdx++] = wy0;
        this.positions[pIdx++] = 30;
        this.positions[pIdx++] = wx1;
        this.positions[pIdx++] = wy0;
        this.positions[pIdx++] = 30;
        this.positions[pIdx++] = wx1;
        this.positions[pIdx++] = wy1;
        this.positions[pIdx++] = 30;
